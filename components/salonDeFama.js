var container = document.querySelector('.salonDeFama');
...
var Faqs = function Faqs() {
	return React.createElement(
		...
		React.createElement(
			...
			React.createElement(
				"span",
				{ className: "team-horario-select" },
				React.createElement(
					"button",
					{ className: "team-horario-button team-horario-button-sel", onClick: function onClick(e) {
							horarioSelect(e, 24);
						} },
					"Horario 2-4"
				),
				React.createElement(
					"button",
					{ className: "team-horario-button", onClick: function onClick(e) {
							horarioSelect(e, 46);
						} },
					"Horario 4-6"
				)
		...
		React.createElement(
			"div",
			{ className: "teams-board" },
			React.createElement("iframe", { id: "iframe-lead", className: "leaderboard-classname", width: "100%", height: "700", src: "https://datastudio.google.com/embed/u/0/reporting/1ec487f9-858c-40ad-ad85-dc3d3c361dfc/page/jPHdC" })
		)
	);
};
